const initialModel1 = {
  config: {  //==================================== Configuration principale ===
    ...
    dataMode: 'online',   // soit 'online' ou 'offline'
  ...
  ui: {  //================================================== User Interface ===
    ...
    currenciesCard: {  //___________________________________ Currencies Card ___
      selectedTab: 'fiats',  // soit 'cryptos' ou 'fiats'
      tabs: {  //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Onglets ~~~
        cryptos: {  //--------------------------------------- Onglet Cryptos ---
          ...
          pagination: {  //...................................... Pagination ...
            ...
            rowsPerPageIndex : 0,  // indice du nbre de ligne sélectionné
        ...
        fiats: {  //---------------------------------------- Onglet Monnaies ---
          filters: {  //............................................ Filtres ...
            text: 'dollar',  // sur noms des monnaies
          },
          sort: {   //....................................... Tri du tableau ...
            column  : 0,
    ...
    walletCard: { //____________________________________________ Wallet Card ___
      selectedTab: 'ajouter',  // soit 'portfolio' ou 'ajouter'
    },
  },
  hasChanged: {  //============================================== A changé ? ===
    coins          : true,
